...
public class CurrencyGameActivity extends AppCompatActivity {
    private User user;
    ...
    private static final String KEY_QUESTION = "currency_question";
    private static final String KEY_CORRECT_ANSWER = "currency_correct_answer";
    private static final String KEY_WRONG_ANSWER_1 = "currency_wrong_answer_1";
    private static final String KEY_WRONG_ANSWER_2 = "currency_wrong_answer_2";
    private static final String KEY_WRONG_ANSWER_3 = "currency_wrong_answer_3";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentLevel = user.getLevelCurrency();

        tvLife.setText(String.valueOf(user.getLife()));
        tvCoin.setText(String.valueOf(user.getCoin()));
        tvLevel.setText("Level " + user.getLevelCurrency() + "/" + TOTAL_LEVELS);
    ...
    private void setQuestionAndAnswers() {
        ...
        String question = "What is the currency of " + country.getName() + " ?";
        String correctAnswer = country.getCurrency();
        String[] wrongAnswers = new String[3];

        wrongAnswers[0] = dbHelper.getRandomCountryExcept(new ArrayList<>(completedLevels)).getCurrency();
        wrongAnswers[1] = dbHelper.getRandomCountryExcept(new ArrayList<>(completedLevels)).getCurrency();
        wrongAnswers[2] = dbHelper.getRandomCountryExcept(new ArrayList<>(completedLevels)).getCurrency();
    ...
    private void checkAnswer(final TextView selectedAnswerView, String chosenAnswer, String correctAnswer) {
        ...
        if (chosenAnswer.equals(correctAnswer)) {
            ...
            int userLevel = user.getLevelCurrency() + 1;
            int currentCoin = user.getCoin() + 3;
            user.setCoin(currentCoin);
            user.setLevelCurrency(userLevel);
